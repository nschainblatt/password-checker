...
def main(password):
    ...
    if count:
        print(f'{password} was found {count} times... You need to change your password!')
    else:
        print(f'Your all good, your password {password} has not been found in any data breaches!')
